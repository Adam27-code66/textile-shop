    ...
    <Link href={`/products/${product.id}`} className="group block">
      <div className="relative aspect-[3/4] overflow-hidden bg-[#13141B]">
        ...
        <button
          ...
          className="absolute top-3 right-3 p-2 bg-[#08090C]/60 backdrop-blur-sm border border-white/[0.06] text-white/80 hover:text-[#E23DFF] transition-all duration-300 opacity-0 group-hover:opacity-100"
        ...
        <button
          ...
          className="absolute bottom-3 left-3 right-3 py-2.5 bg-[#08090C]/80 backdrop-blur-sm border border-white/[0.08] text-white text-xs font-semibold uppercase tracking-wider flex items-center justify-center gap-2 opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 hover:bg-[#8B3DFF]/80"
