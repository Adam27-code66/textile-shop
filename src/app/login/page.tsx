  ...
  return (
    <div className="w-full max-w-md bg-[#0D0E13] border border-white/[0.08] p-8 rounded-xl shadow-2xl relative">
      ...
      <div className="relative flex items-center justify-center mb-6">
        ...
        <span className="bg-[#0D0E13] px-3 text-[10px] uppercase tracking-widest text-[#A6A6B0]">OR EMAIL</span>
        <div className="border-t border-white/[0.08] w-full" />
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <button
          ...
          className="w-full py-3.5 bg-gradient-to-r from-[#8B3DFF] to-[#B84DFF] text-white text-xs font-bold uppercase tracking-wider hover:from-[#7a2ef0] hover:to-[#a83ef0] transition-all duration-300 flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(139,61,255,0.3)] rounded-lg disabled:opacity-50"
        >
